...
<script src="<c:url value='/resources/js/utils/modernizr.custom.js'/>" type="text/javascript"></script>
<script src="<c:url value='/resources/js/utils/clipboard.custom.js'/>" type="text/javascript"></script>
<script src="<c:url value='/resources/js/utils/classie.js'/>" type="text/javascript"></script>
