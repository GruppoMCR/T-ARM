            ...
            <md-card><img ng-src="{{imagePath}}" class="md-card-image"
                ...
                <md-card-content>
                    <div layout="row" layout-align="start center" flex="33">
                        Nome: {{animale.nome}} <br> Razza: {{animale.razza}} <br>
                    </div>
                    <div class="dialogBoxIcons" layout="row"
                        ...
                        <md-button> <!-- 				<div> -->
                            <md-icon
                                    class="material-icons md-light md-8" flex="10"> forward
                            </md-icon>
                        </md-button>
                    ...
                    <div layout="row" layout-align="space-around center" ng-show="false">
                        <md-button>
                            <md-icon class="material-icons md-light md-8"> delete
                            </md-icon>
                        </md-button>
                        <md-button ng-click="showContent($event)">
                            <md-icon class="material-icons md-light md-8"> modify
                            </md-icon>
                        </md-button>
                    </div>
                </md-card-content>
